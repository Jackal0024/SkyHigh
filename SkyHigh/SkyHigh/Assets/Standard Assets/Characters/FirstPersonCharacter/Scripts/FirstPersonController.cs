...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        {
            // Read input
            float horizontal = CrossPlatformInputManager.GetAxis("RightStickX");
            float vertical = CrossPlatformInputManager.GetAxis("RightStickY");
        ...
        private void RotateView()
        {
            ...
            gameObject.transform.Rotate(Vector3.left, vertical);
